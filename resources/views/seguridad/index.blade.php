    ...
    <div class="login-box">
        <div class="login-logo">
            <div class="text-center">
              <img src="{{asset("assets/$theme/dist/img/icstrucks/logonv.jpeg")}}" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-3"
                width="30%" alt="profile">
            </div>

            <a href="/"> <b>VE-AR </b> S.A de C.V. </a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
